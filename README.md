...
Я учусь на 2-м курсе ПМИ (**Центральный Университет**, специализация «Искусственный интеллект»). 
...
#### [RAG Movie Agent](https://github.com/lkazumin/rag-movie-agent) — Персонализированный ИИ-агент для рекомендации фильмов
